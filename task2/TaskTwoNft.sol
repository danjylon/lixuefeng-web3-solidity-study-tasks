...
5. 查看 NFT
  ...
  - 连接你的钱包，查看你铸造的 NFT。
*/
contract TaskTwoNft is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("TaskTwoNft", "TTN")
        Ownable(initialOwner)
    {}

		// ipfs://QmcjBk3BvtxmSoav9ZUqitRe4v1nSzkFcvGXL3eywUCA2n
